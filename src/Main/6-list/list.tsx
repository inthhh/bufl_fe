    ...
    <div>
      ...
      <div className="list-container">
        <div className="list">
          ...
          <button className="list2" onClick={() => openModal("여행을 위해 500만원 모으기")}>
            AI 추천 목표
            <br />
            "여행"을 위해 500만원 모으기
          </button>
          <button className="list3" onClick={() => openModal("한달에 얼마씩 모아야 1억이 될까?")}>
            AI가 도와주는 저축 목표 설정
            <br />
            한달에 얼마씩 모아야 1억이 될까?
          </button>
          <button className="list4" onClick={() => openModal("맥북을 위해 300만원 모으기")}>
            AI 추천 목표
            <br />
            "맥북"을 위해 300만원 모으기
          </button>
          <button className="list5" onClick={() => openModal("노후자금을 위한 최대 저축 금액은?")}>
            AI가 도와주는 저축 목표 설정
            <br />
            노후자금을 위한 최대 저축 금액은?
          </button>
