          ...
          <div className="center_wrap">
            <div className="agree_box">
              <p className="agree_text4">
                ...
                <br />
                제1조 (목적) <br />
                이 약관은 “OOOO주식회사”(이하 “회사”라 한다)가 제공하는 마이데이터 서비스 (이하 “서비스”라 한다)의
                ...
                정보주체인지를 정보제공자가 확인하는 방법을 말합니다.이용자가 직접 개별인증 혹은 통합인증의 방식을
                선택할 수 있습니다.각 기관별로 요구되는 본인인증 정보는 해당 기관의 정책에 따라 상이할 수 있습니다.
                <br />
                <br />
                ...
                <br />
                <br />
                9.“통합인증”이란 고객이 공용의 인증수단을 이용하여 인증행위를 1회 수 행함으로서 다수의 정보제공자에
                인증이 가능한 방식을 말합니다.
                <br />
                <br />
